...
for t in test_image.py test_mgmt.py test_mgmt_image.py test_mgmt_os.py test_transport_serial.py test_transport_ble.py test_smp_proxy.py test_ble_compat.py test_mgmt_proxy_ble.py; do
    echo "=== $t ==="
